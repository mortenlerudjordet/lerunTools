function Get-TargetResource
{
    ...
    if(Get-WmiObject -Class Win32_Product -Filter "IdentifyingNumber ='$IdentifyingNumber'")
    {
        ...
        Write-Verbose -Message "Get-TargetResource: Registry -> DB name: $DatabaseName"
        $WebSitePortNumber = (Get-ItemProperty -Path "HKLM:\SOFTWARE\Microsoft\Service Provider Foundation" -Name "PortNumber").PortNumber
        Write-Verbose -Message "Get-TargetResource: Registry -> Web Site Port Number: $WebSitePortNumber"
        ...
        Write-Verbose -Message "Get-TargetResource: Registry -> VMM User Name: $SCVMMUsername"
        ...
        Write-Verbose -Message "Get-TargetResource: Registry -> Admin User Name: $SCAdminUsername"
        ...
        Write-Verbose -Message "Get-TargetResource: Registry -> Provider User Name: $SCProviderUsername"
        ...
        Write-Verbose -Message "Get-TargetResource: Registry -> Usage USer Name: $SCUsageUsername"
