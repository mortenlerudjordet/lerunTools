...
try
{
	...
	$oInstance = $discoveryData.CreateClassInstance("$MPElement[Name='QND.Hyperv.2016.ReplicaVM']$")
	$oInstance.AddProperty("$MPElement[Name='QND.Hyperv.2016.VM']/VirtualMachineId$", $vm.VMId.ToString())
	$oInstance.AddProperty("$MPElement[Name='QND.Hyperv.2016.ReplicaVM']/PrimaryServerName$", $replica.PrimaryServerName)
	$oInstance.AddProperty("$MPElement[Name='QND.Hyperv.2016.ReplicaVM']/ReplicaServerName$", $replica.ReplicaServerName)
	$oInstance.AddProperty("$MPElement[Name='QND.Hyperv.2016.ReplicaVM']/ReplicationMode$", $vm.ReplicationMode.ToString())
	$oInstance.AddProperty("$MPElement[Name='QND.Hyperv.2016.ReplicaVM']/RelationshipType$", $replica.RelationshipType.ToString())
	$oInstance.AddProperty("$MPElement[Name='QND.Hyperv.2016.ReplicaVM']/FrequencySec$", $replica.FrequencySec)
